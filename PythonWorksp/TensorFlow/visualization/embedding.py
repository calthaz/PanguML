...
tf.app.flags.DEFINE_string('log_dir', './logs/embed-proj-furpics',
						   """Directory where to save embeddings""")
tf.app.flags.DEFINE_integer('num_examples', 4000,
							"""Number of examples to run.""")
tf.app.flags.DEFINE_integer('eval_batch_size', 1435,#2800,
...
def get_embedding():
	...
	with tf.Graph().as_default() as g:
		...
		(images, labels), label_list = read_image.static_inputs(eval_data, FLAGS.eval_batch_size)
