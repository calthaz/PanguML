...
/**
 * <span class="en">test ColorPalette and algorithms to extract colors</span>
 * <span class="zh">测试ColorPalette和颜色提取算法</span>
 *
 */
public class paletteDriver {
	...
	/**
	 * <span class="zh">进行测试</span><span class="en">run the test</span>
	 * @param args
	 */
