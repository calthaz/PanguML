...
import zym.cv.findsimilarimg.ImageEntry;
import zym.tensorflow.general.DevConstants;
import zym.tensorflow.tools.LabelGenerator;


/**
 * <span class="en">This class carries out the algorithm described in
 * <a href="http://grail.cs.washington.edu/projects/query/mrquery.pdf">this paper</a></span>
 * <span class="zh">这个类执行的是<a href="http://grail.cs.washington.edu/projects/query/mrquery.pdf">这个论文</a>中的算法</span>
 * 
 */
public class FastQuerying {
	...
	/**
	 * <span class="en">stores the feature map of a collection of files
	 * follows this pattern: {@code [random prefix]-[currentTimeMillis][DATA_EXT]}
	 * therefore next time the program loads this dir it will look for the latest map and loads it</span>
	 * <span class="zh">按照这个格式：{@code [random prefix]-[currentTimeMillis][DATA_EXT]}
	 * 储存特征数据表，下次加载时会去寻找</span>
	 * 
	 */
	...
	/**
	 * <span class="en">reads all the files under current dir and generate fqdata file</span>
	 * <span class="zh">读该目录下所有文件并且在此处生成fqdata文件</span>
	 */
	public FastQuerying(){
	...
	/**
	 * <span class="zh">传入图片路径在当前目录下寻找保存过的特征图然后比较计算</span>
	 * <span class="en">Use a locally stored fqdata file to find similar images for the draft </span>
	 * @param draftPath <span class="zh">跟别人比较的图片</span><span class="en"></span>
	 */
	...
	/**
	 * <span class="en">delete redundant paths and nonexistent paths.</span>
	 * <span class="zh">删除多余和不存在的路径</span> 
