package zym.tensorflow.inception5h;
...
/**
 *<span class="en"> Sample use of the TensorFlow Java API to label images using a pre-trained zym.tensorflow.inception5h model. </span>
 *<span class="zh">使用TensorFlow Java API的示例。使用预先训练的inception5h模型来标记图像。</span>
 */
public class LabelImage {
  ...
  private static void printUsage(PrintStream s) {
    final String url =
        "https://storage.googleapis.com/download.tensorflow.org/models/zym.tensorflow.inception5h.zip";
    s.println(
  ...
  /**
   * <span class="en">Give classes for paths in args</span>
   * <span class="zh">给args里的文件做出分类</span>
   * @param args
   */
  public static void main(String[] args) {
    ...
    //String modelDir = ; //"D:\\TensorFlowDev\\JavaWorksp\\TensorFlow\\zym.tensorflow.inception5h";
    String modelDir = NativeUtils.loadOrExtract(DevConstants.RES_ROOT+"tf-models/zym.tensorflow.inception5h/tensorflow_inception_graph.pb", 
    		"/zym.tensorflow.inception5h/tensorflow_inception_graph.pb");
    String labelPath = NativeUtils.loadOrExtract(DevConstants.RES_ROOT+"tf-models/zym.tensorflow.inception5h/imagenet_comp_graph_label_strings.txt", 
    		"/zym.tensorflow.inception5h/imagenet_comp_graph_label_strings.txt");
