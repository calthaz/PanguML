...
"""A binary to train model using a single GPU.
  from FurnitureClassifier
...
tf.app.flags.DEFINE_string('train_dir', '../logs/train3500',
                           """Directory where to write event logs """
                           """and checkpoint.""")
tf.app.flags.DEFINE_integer('max_steps', 3500, 
    ...
    class _LoggerHook(tf.train.SessionRunHook):
      ...
      def after_run(self, run_context, run_values):
        ...
        if self._step % FLAGS.eval_frequency == 0:
          ...
          print('%s: precision @ 1 = %.3f' % (datetime.now(), accuracy))
