...
"""Builds the deep neuron network based on TensorFlow TODO-link
from StyleClassifier
  Summary of available functions:
   ...
   For the clearity of this demo I removed stuff about tower and fp16.
"""
...
def accuracy(logits, labels):
  ...
  Args:
    ...
    labels: Labels from distorted_inputs or inputs(). 1-D tensor
            of shape [batch_size]
  Returns: 
    accuracy: Tensor of type float32 that contains a single float between 0 and 1   
  """
